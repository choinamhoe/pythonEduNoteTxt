...
os.chdir(r"E:\cjcho_work\251002\mnist\00_mnist")
...
""" 유틸 쓰기전
batch_size =32
gen = MyGenerator(tr_df, batch_size, img_read)
x,y = next(iter(gen))
"""

import sys
sys.path.append(r"E:\cjcho_work")
import aiUtils
batch_size = 32
tr_gen = aiUtils.MyGenerator(train_df, batch_size, img_read)
