...
import sys
sys.path.append("E:/cjcho_work/250930") ## utils 파일이 있는 경로
...
files = glob.glob("E:/cjcho_work/250930/cat_and_dogs/**/*")
...
teacher = tf.keras.models.load_model("E:/cjcho_work/250930/teacher_model.h5")
teacher.summary()
