...
pred = model.predict(te_x)
mean_absolute_error(test["mpg"], pred) # MAE: 3.3959 -> 1.4372
...
model.fit(train[["sex","class","age"]], train["survived"])
pred = model.predict(test[["sex","class","age"]])
prob = model.predict_proba(test[["sex","class","age"]])
accuracy_score(test["survived"], pred)
f1_score(test["survived"], pred)
precision_score(test["survived"], pred)
recall_score(test["survived"], pred)
...
pred = model.predict(test[["sex","class","age"]])
prob = model.predict_proba(test[["sex","class","age"]])
accuracy_score(test["survived"], pred) #0.6805 -> 0.7638
f1_score(test["survived"], pred)
precision_score(test["survived"], pred)
recall_score(test["survived"], pred)
