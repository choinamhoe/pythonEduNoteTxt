# -*- coding: utf-8 -*-
"""
Created on Thu Aug 28 15:36:54 2025
...
accuracy_score(test["class"], pred) # 0.7584
f1_score(test["class"], pred) # 0.8450
precision_score(test["class"], pred) # 0.7918
recall_score(test["class"], pred) # 0.9058
...
accuracy_score(test["class"], pred) # 0.7607
f1_score(test["class"], pred) # 0.8462
precision_score(test["class"], pred) # 0.7940
recall_score(test["class"], pred) # 0.9058
...
model.fit(train.drop('class', axis = 1), train["class"])
pred = model.predict(test.drop("class", axis=1))
accuracy_score(test["class"], pred) # 0.8653
f1_score(test["class"], pred) # 0.9076
precision_score(test["class"], pred) # 0.9052
recall_score(test["class"], pred) # 0.9100
...
model.fit(train.drop('class', axis = 1), train["class"])
pred = model.predict(test.drop("class", axis=1))
accuracy_score(test["class"], pred) # 0.8253
f1_score(test["class"], pred) # 0.8725
precision_score(test["class"], pred) # 0.9294
recall_score(test["class"], pred) # 0.8222
plot_tree(
    model, filled=True, 
