# -*- coding: utf-8 -*-
"""
Created on Wed Aug 27 09:14:00 2025
...
"""
조금 풀어 놓은 느낌
H0: 근력 운동은 성적향상에 도움이 되지 않는다.
H1: 근력 운동은 성적향상 집중력향상에 도움이 된다.
...
stats.ttest_ind(
    training_ind["A"], training_ind["B"], equal_var=False)
...
"""
비모수 검정
 직접 구하는 부분 320 page - 324페이지
wilcoxon t test와 대응
H0: 특정 처리 전/후의 중앙값의 차이가 없다.
H1: 특정 처리를 하기전 과 하고 난 후의 중앙값에 차이가 있다.
"""
...
##### 카이제곱 검정은 범주형 데이터의 독립성을 검증할 때 주로 사용
# 범주형 데이터에 대한 통계 진행할 일이 많지 않으므로 생략
