# -*- coding: utf-8 -*-
"""
Created on Mon Aug 18 14:10:21 2025
...
ax3.plot(data, color = "black", linestyle="--")
ax3.cla()
ax3.plot(data, color = "black", linestyle=":")
ax3.cla()
ax3.plot(data, color = "black", linestyle=":", lw=3, ds="steps")
ax1.cla()
#히스토그램
...
ax2.set_xticklabels("") #x축 라벨 삭제
ax2.set_yticklabels("")  #y축 라벨 삭제
ax1.tick_params(
...
data2 = np.random.RandomState(42).randn(51).cumsum()
data2
...
ax.set_xticklabels(["0m","25m","50m"],rotation=30, fontsize=12)
ax.set_aspect("equal") #종횡비 1:1
#plt.savefig("fig.png",dpi=600) #이미지 저장(절대경로로 저장)
plt.savefig("fig.png",dpi=600) #이미지 저장(상대경로로 저장)
