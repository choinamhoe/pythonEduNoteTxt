# -*- coding: utf-8 -*-
"""
Created on Thu Sep  4 09:20:33 2025
...
#5분에 시작
te_seq = tr.keras.preprocessing.sequence.pad_sequences(
    te_x,maxlen=200)
te_seq.shape
"""
...
x = tf.keras.layers.Embedding(500,16)(inputs)
x = tf.keras.layers.SimpleRNN(8)(x)
